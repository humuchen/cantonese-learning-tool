#!/usr/bin/env node
/**
 * Anki Jyutping Deck Generator (TypeScript)
 * 功能：
 *   1. 生成 Anki 兼容牌组 CSV
 *   2. 支持「正面：汉字」/「背面：Jyutping + Pinyin + 例句」
 *   3. 输出 .csv（可直接导入 Anki）
 *
 * 依赖：无（纯 Node.js 标准库）
 */
...
const JYUTPING: Record<string, string> = {
  // 代词
  "我": "ngo5", "你": "nei5", "佢": "kwai5",
  "佢哋": "kwai5 dei6", "我哋": "ngo5 dei6",
  "自己": "zi6 gei2", "大家": "daai6 gaa1",

  // 动词
  "係": "hai6", "唔": "m4", "知": "zi1",
  "叫": "giu3", "去": "heoi3", "睇": "tai2",
  "食": "sik6", "飲": "yam2", "買": "maai5",
  "俾": "bei2", "見": "gin3", "行": "haang4",
  "返": "fan1", "着": "zoek3", "聽": "teng1",
  "諗": "naam2", "問": "man6", "講": "gong2",
  "寫": "sie2", "讀": "douk6", "玩": "waan5",
  "做": "zo3", "唱": "coeng3", "發": "fat3",
  "收": "sau1", "開": "hoi1", "閂": "min1",
  "拎": "ling1", "攞": "lo5", "走": "zau2",
  "起": "hei2", "落": "luk6", "過": "gwo3",
  "入": "jap6", "出": "ceot1", "上": "soeng6",
  "睡": "seoi3", "瞓": "fan2", "醒": "seng2",
  "病": "bing3", "著": "zoek3", "生": "saang1", "死": "sei2",

  // 名词
  "日": "jat6", "夜": "je6", "天": "tin1",
  "間": "gān1", "時": "si4", "邊": "bin1",
  "度": "dou6", "處": "cwai6", "地": "dei6",
  "月": "jyut6", "年": "nin4", "歲": "sui3",
  "分": "fan1", "秒": "miu5", "刻": "hak1",

  // 形容词
  "好": "hou2", "唔好": "m4 hou2", "靚": "leung6",
  "醜": "cau2", "熱": "re3", "凍": "dung6",
  "渴": "hut3", "餓": "o3", "累": "lui6",
  "飽": "bou2", "濕": "saap6", "乾": "gon1",
  "輕": "hing1", "重": "zung6", "大": "daai6",
  "細": "sai3", "多": "do1", "少": "siu2",
  "長": "cong4", "短": "dyun5", "新": "san1",
  "舊": "gau3", "遠": "jyun5", "近": "zeon3",
  "高": "gou1", "低": "dai1", "直": "zik6",
  "彎": "waan1", "硬": "ngeng5", "軟": "jyun5",
  "滑": "waat6", "澀": "saap9", "苦": "hou2",
  "酸": "syun1", "甜": "tim4", "辣": "lat6",
  "鮮": "sin1", "腥": "sing1", "香": "hiong1",
  "臭": "cau3", "淡": "daam6", "濃": "nung4",
  "淨": "zing3", "濁": "jyuk6", "亂": "lyun6",
  "齊": "cwai4", "同": "tung4", "似": "ci5",
  "正": "zing3", "勁": "ging3", "抵": "di2",
  "難": "gaan4", "易": "jik1", "快": "faai3",
  "慢": "maam6", "穩": "wan2", "險": "him2",
  "安": "on1", "危": "wai4", "富": "fu6",
  "窮": "kwing4", "貴": "goi3", "平": "pieng4",
  "值": "zik6", "便": "bin6",

  // 副词/连词
  "咁": "gam3", "咁樣": "gam3 joeng6",
  "點": "den2", "點樣": "den2 joeng6",
  "幾": "gei2", "幾多": "gei2 do1",
  "先": "sin1", "至": "zi3", "先至": "sin1 zi3",
  "已經": "ji5 ging1", "未": "mei6", "未曾": "m4 cang4",
  "曾": "cang4", "曾經": "cang4 ging1",
  "依然": "ji1 jin4", "再": "zoi3", "仲": "zung6",
  "更加": "gaa3 zyo1", "都": "dou1", "全部": "cyun4 bou6",
  "分別": "fan1 beoi3", "同樣": "toeng4 joeng6",
  "相同": "soeng1 tong4", "一樣": "jat1 joeng6",
  "其他": "kei4 tai1", "每個": "mou6 go3",
  "任何": "jik1 ho6", "所有": "syu2 jau5",
  "各種": "gam2 cong6",

  // 疑问词
  "邊個": "bin1 go3", "乜嘢": "mah6 je5",
  "咩": "me1", "啫": "ze1", "喺": "hai2",

  // 语气词
  "啦": "laa1", "喇": "laa3", "㗎": "gaa3",
  "吖": "a1", "喎": "wɔ1", "嘛": "mɔ1",
  "囉": "lo1", "喂": "wai3", "唉": "aai3",
  "喔": "ok3", "啊": "a3", "呀": "aa1",
  "呢": "ni1", "個": "go3",
  ...
  // 固定搭配
  "多謝": "do1 ze6", "唔該": "m4 gor1",
  "再見": "zoi3 gin3", "早安": "zou2 an1",
  "晚安": "aan1 je6", "唔該晒": "m4 gor1 syu3",
  "埋單": "maai4 daan1", "食飯未": "sik6 faan6 mei6",
  "邊度": "bin1 dou6", "咁好": "gam3 hou2",
  "點解": "den2 gae2", "幾時": "gei2 si4",
  "唔使": "m4 sei3", "冇問題": "mou5 man6 tai4",
  "可以": "ho2 ji5", "一定": "jat1 ding6",
  "可能": "mo4 ng4", "應該": "jing1 gai1",
  "不如": "bat1 jyu4", "好似": "hou2 ci5",
  "因為": "jan1 wai6", "所以": "sou2 ji6",
  "但是": "daai6 gam6", "或者": "waak6 ze2",
  "而且": "ji3 qie2", "雖然": "syu1 jin4",
  "如果": "jyu4 gwo3", "即使": "zik1 ging2",
  "無論": "man4 lat6", "而家": "ji4 gaa1",
  "依家": "ji1 gaa1", "啱啱": "naam1 naam1",

  // 身体部位
  "手": "seu2", "腳": "gok3", "頭": "tau4",
  "面": "min6", "眼": "jyun5", "耳": "jyi5",
  "鼻": "bai4", "嘴": "zeoi2", "牙": "jaa4",
  "舌": "sit6", "頸": "gang2", "膊": "bo3",
  "心": "sam1", "肝": "gan1", "腸": "coeng4",
  "肚": "dou6", "背": "bak3", "腿": "teoi2",
  "膝": "sap1", "腰": "jiu1", "胸": "hung1",
  "肩": "gin1", "喉": "hau4", "骨": "gut3",
  "肉": "juk6", "血": "hyut3", "皮": "pai4",
};
...
const PINYIN_MAP: Record<string, string> = {
  ...
  "各種": "ge3 zhong3",
  "邊個": "bian1 gei4", "乜嘢": "mie2 ye3", "咩": "mie1", "啫": "zhe2", "喺": "hai4",
 ...
 * 生成 Anki CSV 牌组
 */
function createAnkiCSV(text: string, outputPath: string): void {
  const rows: string[] = ['Hanzi,Jyutping,Pinyin,Example'];
  ...
  for (const char of text) {
    if (isCJK(char)) {
      ...
      rows.push(`${char},${jyut},${py},${example}`);
    }
  }

  fs.writeFileSync(outputPath, rows.join('\n'), 'utf8');
  console.log(`[OK] Anki 牌组已保存：${outputPath}`);
  console.log(`     共 ${rows.length - 1} 张卡片`);
 ...
 * 生成学习用 CSV（含对比表）
 */
function createStudyCSV(text: string, outputPath: string): void {
  const rows: string[] = ['Hanzi,Jyutping,Pinyin,Example (Jyutping + Pinyin)'];
  ...
  fs.writeFileSync(outputPath, rows.join('\n'), 'utf8');
  console.log(`[OK] 对照表已保存：${outputPath}`);
  console.log(`     共 ${rows.length - 1} 条记录`);
}
...
function main(): void {
  ...
  console.log('  Anki Jyutping 牌组生成器 (TypeScript)');
  console.log('='.repeat(50));
  console.log();
  console.log('用法：');
  console.log('  node anki_generator.js [文本] --csv 输出.csv');
  console.log('  node anki_generator.js [文本] --anki 输出.csv');
  console.log('  node anki_generator.js --help');
  console.log();

  if (process.argv.includes('--help')) {
    console.log('示例：');
    console.log('  node anki_generator.js "你好我好大家" --anki deck.csv');
    console.log('  node anki_generator.js "食飯未呀" --csv study.csv');
    return;
  }
  ...
  if (!text) {
    ...
    console.log('示例：node anki_generator.js "我係广州人" --anki jyutping.csv');
    return;
  }

  const finalMode = mode || 'anki';
  const finalOutput = output || 'jyutping_deck.csv';

  console.log(`输入文本：${text}`);
  console.log();

  if (finalMode === 'anki') {
    createAnkiCSV(text, finalOutput);
  } else {
    createStudyCSV(text, finalOutput);
  }
}
